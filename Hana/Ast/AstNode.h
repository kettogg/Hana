...
namespace hana
{
	...
	public:
		...
		{
			std::cerr << location.file_name << ": Line " << location.first_line
					  << " Column " << location.first_column << "-"
					  << location.last_column << " :" << msg << std::endl;
		}
	...
	{
	public:
		Identifier(const std::string &name, YYLTYPE loc)
			: name(name), location(loc) {}
		Identifier(const std::string &structName, const std::string &name,
				   YYLTYPE loc)
			: name(name), structName(structName), location(loc) {}
		Identifier(const Identifier &id)
			: name(id.name), structName(id.structName), location(id.location) {}
